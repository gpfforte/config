...
if [ -f "$HOME/scripts/start.py" ]; then
    python "$HOME/scripts/start.py" | lolcat
fi
...
# SPECIFIC FOR DISTRO
#
DISTRO=$(grep -Po "(?<=^ID=).+" /etc/os-release)
export DISTRO
# echo $distro
